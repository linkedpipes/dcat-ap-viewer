//
// Module for working with a single entity, i.e. reading properties.
//

import {JsonLdEntity, Literal, JsonLdValue} from "./model";
...
export function getResource(
  entity: JsonLdEntity, predicate: string): string | undefined {
  //
  return getFirst(getResources(entity, predicate));
}

export function getResources(entity: JsonLdEntity, predicate: string): string[] {
...
export function getValue(
  entity: any, predicate: string): JsonLdValue | undefined {
  return getFirst(getValues(entity, predicate));
}

export function getValues(
  entity: any, predicate: string): JsonLdValue[] {
