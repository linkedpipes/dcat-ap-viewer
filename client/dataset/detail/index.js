...
register({
  ...
  "strings": {
    "cs": {
      ...
      , "file_unavailable": "Soubor byl {date} nedostupný. {note}"
      , "schema": "Schéma"
      , "schema_available" : "Schéma bylo {date} dostupné."
      , "schema_unavailable" : "Schéma bylo {date} nedostupné. {note}"
      ...
      , "documentation_unavailable": "Dokumentace byla {date} nedostupná. {note}"
      ...
      , "endpoint_description": "Popis endpointu"
      , "endpoint": "Endpoint"
      , "data_service": "Datová služba"
      , ...termsOfUseString["cs"],
    },
    "en": {
      ...
      , "file_unavailable": "The file was unavailable on {date}. {note}"
      , "schema": "Schema"
      , "schema_available" : "Schéma bylo {date} nedostupné."
      , "schema_unavailable" : "The schema was unavailable on {date}. {note}"
      , "licence": "Licence"
      ...
      , "documentation_unavailable": "The documentation was unavailable on {date}. {note}"
